...
#define DN_VAR_STEP_COUNTER           0x40F8 // Steps for finding hidden Pokémon
...
#define HIDDEN_MON_STEP_COUNT       25  // Look for hidden Pokémon every x steps
#define HIDDEN_MON_SEARCH_RATE      50   // x% chance of finding hidden Pokémon every x steps
