...
#define WE_FLAG_NO_ENCOUNTER        0x33       // If this flag is set, wild encounters will be disabled.
...
// Wild Battle Flags
#define WE_FLAG_FORCE_DOUBLE_WILD    0x36     // If this flag is set, all land and surfing wild battles will be double battles.
#define WE_SMART_WILD_AI_FLAG        0     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define WE_FLAG_NO_CATCHING          0x2C     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define WE_FLAG_NO_RUNNING           0x2D     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
...
#define WE_OWE_FLAG_DISABLED                    0x37       // Replace 0 with a flag to use it to enable/disable generated OWEs.
