...
#define P_FLAG_EGG_MOVES                 0x28       // If this flag is set, enables egg move relearner.
#define P_FLAG_TUTOR_MOVES               0x29       // If this flag is set, enables tutor move relearner.
